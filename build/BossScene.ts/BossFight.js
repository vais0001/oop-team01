...
export default class BossFight extends Scene {
    ...
    render(canvas) {
        ...
        if (this.endingScene) {
            if (this.nextText === 1000)
                this.bossFightText.textTwelve(canvas, this.bubble, this.talker);
            if (this.nextText === 1001)
                this.bossFightText.textThirteen(canvas, this.bubble, this.talker);
            if (this.nextText === 1002)
                this.bossFightText.textFourteen(canvas, this.bubble, this.talker);
        }
        if (this.startingCutscene > 0) {
